# FilaScale — Display Design

Das Display ist ein **ST7920 128×64 Pixel** Monochrom-LCD (kompatibel mit Ender 3).
...
_Zeigt die zuvor in Page 3 ausgewählte Spule zur Bestätigung an._
...
_Wenn Messung vom Gespeicherten Gewicht im Backend abweicht_
...
_Alle Entities, welche in HomeAssistant / Webinterface via Switch dargestellt werden_
